package com.yayi.cloud.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "yayi")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "yayi")
