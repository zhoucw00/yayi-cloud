package com.yayi.cloud.module.infra.service.codegen.inner;
...
import com.yayi.cloud.framework.apilog.core.annotation.ApiAccessLog;
import com.yayi.cloud.framework.apilog.core.enums.OperateTypeEnum;
import com.yayi.cloud.framework.common.exception.util.ServiceExceptionUtil;
...
import com.yayi.cloud.framework.common.util.date.LocalDateTimeUtils;
import com.yayi.cloud.framework.common.util.object.BeanUtils;
import com.yayi.cloud.framework.common.util.object.ObjectUtils;
import com.yayi.cloud.framework.common.util.string.StrUtils;
import com.yayi.cloud.framework.excel.core.annotations.DictFormat;
import com.yayi.cloud.framework.excel.core.convert.DictConvert;
import com.yayi.cloud.framework.excel.core.util.ExcelUtils;
import com.yayi.cloud.framework.mybatis.core.dataobject.BaseDO;
...
import com.yayi.cloud.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.yayi.cloud.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.yayi.cloud.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.yayi.cloud.module.infra.enums.codegen.CodegenSceneEnum;
import com.yayi.cloud.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.yayi.cloud.module.infra.enums.codegen.CodegenVOTypeEnum;
import com.yayi.cloud.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    /**
     * 是否为 yayi-cloud 项目，用于解决 Boot 和 Cloud 的 api 模块兼容性问题
     *
     * true  - 需要有 yayi-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.yayi.cloud.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/yayi-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/yayi-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "yayi-module-${table.moduleName}/" + // 顶级模块
                "yayi-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "yayi-module-${table.moduleName}/" + // 顶级模块
                "yayi-module-${table.moduleName}-server/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "yayi-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "yayi-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
