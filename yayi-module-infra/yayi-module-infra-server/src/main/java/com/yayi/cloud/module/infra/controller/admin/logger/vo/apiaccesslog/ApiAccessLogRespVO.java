package com.yayi.cloud.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.yayi.cloud.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.yayi.cloud.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "yayi，牛逼！")
    @ExcelProperty("结果提示")
