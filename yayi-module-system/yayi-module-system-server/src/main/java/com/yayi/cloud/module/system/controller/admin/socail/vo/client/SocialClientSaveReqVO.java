package com.yayi.cloud.module.system.controller.admin.socail.vo.client;
...
import com.yayi.cloud.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "yayi商城")
