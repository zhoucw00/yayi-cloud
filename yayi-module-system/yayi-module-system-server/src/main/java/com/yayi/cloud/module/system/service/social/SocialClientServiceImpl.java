package com.yayi.cloud.module.system.service.social;
...
import com.yayi.cloud.framework.common.util.cache.CacheUtils;
import com.yayi.cloud.framework.common.util.http.HttpUtils;
import com.yayi.cloud.framework.common.util.object.BeanUtils;
import com.yayi.cloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.yayi.cloud.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.yayi.cloud.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.yayi.cloud.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.yayi.cloud.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.yayi.cloud.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.yayi.cloud.module.system.dal.dataobject.social.SocialClientDO;
import com.yayi.cloud.module.system.dal.mysql.social.SocialClientMapper;
import com.yayi.cloud.module.system.dal.redis.RedisKeyConstants;
import com.yayi.cloud.module.system.enums.social.SocialTypeEnum;
import com.yayi.cloud.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.yayi.cloud.framework.common.util.collection.MapUtils.findAndThen;
import static com.yayi.cloud.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.yayi.cloud.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${yayi.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${yayi.wxa-subscribe-message.miniprogram-state:formal}")
